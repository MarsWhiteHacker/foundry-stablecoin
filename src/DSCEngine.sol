 ...
 *
 * The systme is designed to be as minimal as possible, and have the tokens maintain a 1 token == $1 peg.
...
contract DSCEngine is ReentrancyGuard {
    ...
    /**
     * @param amountDscToMint The amount of decentrilized stablecoin to mint
     ...
     * @notice A known bug would be if protocol were 100% or less collateralized, then we wouldn't be able to incentive the liquidators
